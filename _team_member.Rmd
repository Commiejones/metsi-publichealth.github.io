...
if (github != "") {
  title <- paste(title, icon_link("bi bi-github", url = paste0("https://github.com/", github)))
}

if (twitter != "") {
  title <- paste(title, icon_link("bi bi-twitter", url = paste0("https://twitter.com/", twitter)))
}

if (orcid != "") {
  title <- paste(title, icon_link("ai ai-orcid", url = paste0("https://orcid.org/", orcid)))
}

if (bluesky != "") {
  title <- paste(title, icon_link("bi bi-bluesky", url = paste0("https://", bluesky)))
}
```
